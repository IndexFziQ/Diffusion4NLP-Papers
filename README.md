...
1. **Diffusion-LM Improves Controllable Text Generation.** *Xiang Lisa Li, John Thickstun, Ishaan Gulrajani, Percy Liang, Tatsunori B. Hashimoto.* [[pdf](https://arxiv.org/pdf/2205.14217.pdf)] [[code](https://github.com/XiangLi1999/Diffusion-LM)]
2. **SEQUENCE TO SEQUENCE TEXT GENERATION WITH DIFFUSION MODELS.** Under review in ICLR 2023. [[pdf](https://openreview.net/pdf?id=jQj-_rLVXsj)]
